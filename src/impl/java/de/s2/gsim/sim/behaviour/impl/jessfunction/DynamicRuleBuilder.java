...
public class DynamicRuleBuilder {
    ...
    public String increaseIntervalRangeInExperimentalRule(TreeExpansionBuilder b
            , RuntimeAgent agent
            , RLRule braRule
            , String stateName
            , Fact statefactelem
    ...
    public Fact addStateFactCategoryElemFromStatefact(Fact state, String attributeName, String categoryValue, Context context) throws JessException {
    ...
    public Fact addStateFactIntervalElemFromParentElem(String stateName, Fact stateFactElem, double from, double to, Context context) throws JessException {
    ...
    public Fact addStateFactIntervalElemFromStatefact(String stateName, String paramName, Fact stateFactElem, double from, double to, Context context)
    ...
    protected String createNewExperimentalRuleCat(TreeExpansionBuilder b, RLRule r, String stateName, String paramToExpand,
    ...
    protected String createNewSelectionNodesCat(TreeExpansionBuilder b, RLRule r, String stateName, String param, List<String> fillers,
