...
import gsim.sim.behaviour.impl.jessfunction.SimpleSoftmaxSelector;
import gsim.sim.behaviour.impl.jessfunction.ToInstPath;
import gsim.sim.behaviour.util.CollectiveTreeDBWriter;
import gsim.sim.behaviour.util.IndividualTreeDBWriter;
...
public class JessHandler implements java.io.Serializable {
    ...
    private void assertParameter(Constant param) {
        ...
        try {
            ...
            if (gsim.util.Utils.isNumerical(val)) {
