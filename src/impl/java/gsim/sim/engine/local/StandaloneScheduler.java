...
public class StandaloneScheduler implements SimulationScheduler {
    ...
    private static Logger logger = Logger.getLogger(StandaloneScheduler.class);
    ...
    private void notifyStep() {
        ...
        while (iter.hasNext()) {
            SimulationListener l = (SimulationListener) iter.next();
            try {
            l.instanceStep(this.model.getId().toString(), time);
            } catch (Exception e) {
                e.printStackTrace();
            }
        }
