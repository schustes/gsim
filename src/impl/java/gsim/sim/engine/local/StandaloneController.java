...
import de.s2.gsim.sim.engine.SimulationInstanceListener;
import de.s2.gsim.sim.engine.Steppable;

public class StandaloneController implements Controller {

    private static Logger logger = Logger.getLogger(StandaloneController.class);
    ...
    // Current time of the model to be scheduled
    private int time = 0;

    public StandaloneController(Steppable model) {
        this.model = model;
    }
