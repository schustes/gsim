...
public class BehaviourFrame extends Frame {
    ...
    public void removeRLRule(String name) throws gsim.def.GSimDefException {

        if (super.getDeclaredFrame(RL_LIST, name) == null && getChildFrame(RL_LIST, name.trim()) != null) {
            throw new gsim.def.GSimDefException("This RLNode can't be removed, because it is defined in a parent of this frame.");
        } else if (super.getDeclaredFrame(RL_LIST, name) == null && getChildFrame(RL_LIST, name) == null) {
            throw new gsim.def.GSimDefException("RLNode " + name + " could not be found.");
        }
    ...
    public void removeRule(String name) throws gsim.def.GSimDefException {

        if (super.getDeclaredFrame(RULE_LIST, name) == null && getChildFrame(RL_LIST, name) != null) {
            throw new gsim.def.GSimDefException("This Rule can't be removed, because it is defined in a parent of this frame.");
        } else if (super.getDeclaredFrame(RULE_LIST, name) == null && getChildFrame(RL_LIST, name) == null) {
            throw new gsim.def.GSimDefException("Rule " + name + " could not be found.");
        }
