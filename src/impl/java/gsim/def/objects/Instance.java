...
public class Instance extends Unit {
    ...
    public synchronized Attribute getAttribute(String listname, String attrName) {
    ...
    public synchronized Attribute[] getAttributes(String listname) {
    ...
    public synchronized String[] getAttributesListNames() {
    ...
    public synchronized Instance getChildInstance(String name) {
    ...
    public synchronized Instance getChildInstance(String listname, String name) {
        ArrayList list = (ArrayList) objectLists.get(listname);
        if (list != null) {
    ...
    public synchronized String[] getChildInstanceListNames() {
    ...
    public synchronized Instance[] getChildInstances(String listname) {
    ...
    public synchronized Frame getDefinition() {
        return frame;
    }
    ...
    public synchronized boolean inheritsFrom(Frame f) {
    ...
    public synchronized boolean inheritsFrom(String f) {
    ...
    public synchronized void removeAttribute(String listName, String attributeName) {
        ArrayList list = (ArrayList) attributeLists.get(listName);
        if (list != null) {
            Iterator iter = list.iterator();
            while (iter.hasNext()) {
    ...
    public synchronized void removeChildInstance(String listname, String instanceName) {
    ...
    public synchronized Object resolveName(String[] path) {
    ...
    public synchronized void setAttribute(Attribute a) {
    ...
    public synchronized void setAttribute(String listname, Attribute a) {
        if (attributeLists.containsKey(listname)) {
            ArrayList list = (ArrayList) attributeLists.get(listname);
            ListIterator iter = list.listIterator();
            while (iter.hasNext()) {
    ...
    public synchronized void setChildInstance(Instance instance) {
    ...
    public synchronized void setChildInstance(String listname, Instance instance) {
     ...
     */
    public synchronized void setFrame(Frame parent) {
        if (parent == null) {
            return;
        }
     ...
     *            Frame
     */
    protected synchronized void instanciate(Frame frame) {
