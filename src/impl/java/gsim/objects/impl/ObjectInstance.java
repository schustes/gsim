...
public class ObjectInstance implements ObjectInstanceIF, UnitWrapper {
    ...
    public ObjectInstance(Environment env, Instance real) {
        this.env = env;
        this.real = real;
    }
    ...
    public ObjectInstanceIF copy() {
        ...
        return new ObjectInstance(env, copy);
    }
